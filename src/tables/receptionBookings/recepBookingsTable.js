...
import { COLUMNS, GROUPED_COLUMNS } from "./recepBookingColumns";
import Pagination from "../common/Pagination";
// import { GlobalFilter } from '../common/GlobalFilter';

// import getOrders from '../../../services/getOrders'
// import getCustomer from '../../../services/getCustomerService'
import getReceptionBookings from "../../services/getReceptionBookings";
import { toast } from "react-toastify";

export const RecepBookingsTable = () => {
  ...
  useEffect(async () => {
    ...
    const records = await getReceptionBookings();
    let books = [];
    records.forEach((r) => {
      let oneBook = {
        _id: r._id,
