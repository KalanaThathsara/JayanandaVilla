...
import { COLUMNS, GROUPED_COLUMNS } from "./dayoutBookingColumns";
import Pagination from "../common/Pagination";
// import { GlobalFilter } from '../common/GlobalFilter';

// import getOrders from '../../../services/getOrders'
// import getCustomer from '../../../services/getCustomerService'
import getDayoutBookings from "../../services/getDayoutBookings";
import { toast } from "react-toastify";

export const DayoutsBookingsTable = () => {
  ...
  useEffect(async () => {
    ...
    const records = await getDayoutBookings();
    let books = [];
    records.forEach((r) => {
      let oneBook = {
        _id: r._id,
        ...
        // status: r.status,
        packageNo: r.package ? r.package.packageNo : "",
        package: r.package ? r.package.packageName : "",
        bookDate: new Date(r.date).toLocaleDateString(),
        adults: r.numOfPersons.adults,
        childs: r.numOfPersons.childs,
        total: `Rs ${r.total}`,
        customer: r.customer ? r.customer.username : "",
        contactNo: r.customer ? r.customer.contactNo : "",
        email: r.customer ? r.customer.email : "",
      };
      // r.dates.forEach((d) => {
