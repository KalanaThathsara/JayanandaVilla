...
import addReception from "../services/addReception";
import addReceptionImage from "../services/addReceptionImage";

function AddReceptionHall() {
  ...
  const submit = async (e) => {
    ...
    await addReception(packageData);
    console.log("NOI1", nameOfImage);
    console.log("NOI2", nameOfImage2);
    console.log("NOI3", nameOfImage3);

    setTimeout(function () {
      addReceptionImage(file, packageData.packageNo + 1, 1).then(() => {
        addReceptionImage(file2, packageData.packageNo + 2, 2).then(() => {
          addReceptionImage(file3, packageData.packageNo + 3, 3);
        });
      });
    }, 1000);
    setLoading(false);
    ...
    <div>
      <form className="container" autoComplete="off">
        ...
        <button
          onClick={submit}
          type="submit"
          className="btn btn-primary float-right mt-3 col-12"
        >
...
export default AddReceptionHall;
