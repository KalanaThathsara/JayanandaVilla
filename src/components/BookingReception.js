...
import bookReceptionHall from "../services/addReceptionBooking";
import getOneRecepPackages from "../services/getOneRecepPackage";
import ReceptionBookedCalender from "./ReceptionBookedCalender";

function BookingReception(props) {
  ...
  async function fetchRoom() {
    const room = await getOneRecepPackages(props.match.params.id);
  ...
  const calculateTotal = () => {
    ...
    let subtotal = parseInt(roomData.aprice) * parseInt(numOfPersons.adults);
  ...
  const bookARoom = (e) => {
    ...
    if (userID) {
      ...
      bookReceptionHall(booking).then(() =>
        props.history.push("/user/receptionhall")
      );
    } else {
      toast.error("Please Login to Continue Booking");
      props.history.push("/user/login");
...
export default BookingReception;
