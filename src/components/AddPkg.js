                ...
                <div className="row">   
                    ...
                    <div className="col-6">
                        <div className="row">
                            <div className="form-group col-12">
                                <label htmlFor="roomName" className="col-5"> Name</label> 
                                <input onChange={onchange} value={roomData.name} className="form-control col-11 ml-3"  type="text" id="name" name="name" />
                            </div>
                            <div className="form-group col-12">
                    ...
                    onClick={submit} 
                     type="submit" className="btn btn-primary float-right m-1 col-12">
                        {productSaved ?  `Package Saved`: 'Save Package'}</button>
                    {/* <div>
